            ...
            <div className="max-w-3xl mx-auto space-y-12">
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="space-y-8 font-light text-sm leading-relaxed text-savron-silver/80">
                    ...
                    <section className="space-y-4">
                        ...
                        <p>If you need to cancel or reschedule, please do so at least 24 hours in advance through the booking portal, by email, or by responding <em>No</em> to your Google Calendar appointment invitation (from your barber or from <strong>SAVRON</strong> at <strong>savronmn@gmail.com</strong> when the shop calendar is used). Declining the invite cancels the appointment and frees the slot. Failure to provide sufficient notice or failure to show up for an appointment may result in a cancellation fee or restriction of future booking privileges.</p>
                    </section>
