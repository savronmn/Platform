        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-xl mx-auto space-y-8">
            ...
            <div className="text-center space-y-2">
                <div className="w-12 h-12 mx-auto bg-savron-green/15 border border-savron-green/25 rounded-full flex items-center justify-center">
                    <Link2 className="w-5 h-5 text-savron-green" />
                </div>
                ...
                <div className="space-y-4">
                    {[
                        ...
                        <div key={i} className="flex gap-3">
                            <div className="w-6 h-6 flex-shrink-0 bg-savron-green/10 border border-savron-green/20 rounded-full flex items-center justify-center text-savron-green text-[10px] font-heading">
                                {i + 1}
                            </div>
                            <div>
