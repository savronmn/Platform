...
export const blogPosts: BlogPost[] = [
  {
    ...
    keywords: [
      'Minneapolis barbershop services',
      'North Loop barbershop menu',
      'SAVRON barbershop Minneapolis',
      'men haircut Minneapolis',
      'fade haircut Minneapolis',
      'skin fade Minneapolis',
      'mid fade taper Minneapolis',
      'scissor cut men Minneapolis',
      'long hair mens haircut Minneapolis',
      'hot towel shave Minneapolis',
      'beard trim Minneapolis',
      'beard sculpting Minneapolis',
      'straight razor shave Minneapolis',
      'executive grooming Minneapolis',
      'luxury barbershop Minneapolis',
      'premium mens grooming studio',
      'kids haircut barbershop Minneapolis',
      'mens eyebrow grooming Minneapolis',
      'book barber online Minneapolis',
      'barbershop trends 2026',
      'Manissance mens grooming',
      'refined fade haircut men',
      'textured crop haircut men',
      'haircut and beard trim Minneapolis',
      'best barbershop downtown Minneapolis',
    ],
    content: [
      {
        type: 'intro',
      ...
      {
        type: 'list',
        heading: 'Best for + keywords this service hits',
        items: [
          'Low fade, mid fade, taper fade, and skin fade requests in one appointment',
          'Textured crop, French crop, side part, and classic scissor cuts',
          'Professionals who need a sharp look every 2–3 weeks without over-styling',
          'First-time SAVRON clients who want the core experience before upgrading',
          'Book direct: savronmn.com/booking?service=Signature%20Cut',
        ],
      },
      {
        type: 'h2',
      ...
      {
        type: 'list',
        heading: 'Best for + what is included',
        items: [
          'Job interviews, presentations, galas, and milestone events in Minneapolis',
          'Hot towel shave Minneapolis clients associate with traditional craft done right',
          'Eyebrow grooming for clean framing without over-plucking',
          'The "reset appointment" after travel, a long stretch between cuts, or a big life moment',
          'Executive grooming, premium barbershop experience, full-service mens grooming',
          'Book direct: savronmn.com/booking?service=The%20Executive',
        ],
      },
      {
        type: 'h2',
      ...
      {
        type: 'list',
        heading: 'Trending beard + shave keywords this service covers',
        items: [
          'Beard trim, beard shape-up, beard line-up, and beard sculpting',
          'Hot towel shave, hot lather shave, straight razor finish Minneapolis',
          'Fade into beard, taper with stubble, jaw contour grooming',
          'Men growing a beard back in but needing professional geometry first',
          'Clients who want barbershop craftsmanship without booking two separate services',
          'Book direct: savronmn.com/booking?service=Haircut%20%2B%20Beard%20%2B%20Hot%20Towel%20Shave',
        ],
      },
      {
        type: 'h2',
      ...
      {
        type: 'list',
        heading: 'Who should book Long Styles',
        items: [
          'Men growing out a fade who need shape while length catches up',
          'Curly, wavy, and thick textures that need dry-cutting expertise',
          'Artists, musicians, and creatives who want length with structure',
          'Anyone tired of "salon" energy but needing more than a quick trim',
          'Book direct: savronmn.com/booking?service=Long%20Styles%20Haircut',
        ],
      },
      {
        type: 'h2',
      ...
      },
      {
        ...
        items: [
          ...
          'Book direct: savronmn.com/booking?service=Kids%20Cut',
        ],
      },
      {
        type: 'h2',
