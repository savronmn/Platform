            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link
                        ...
                        className="group flex items-center gap-2 px-4 py-2 border border-white/25 rounded hover:border-white/50 text-white/70 hover:text-white transition-all duration-300"
                    >
